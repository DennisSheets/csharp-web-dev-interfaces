...
namespace IceCreamShop
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            availableFlavors.Sort(new FlavorComparer());        // combining the 2 lines above
            ...
            availableCones.Sort(new CostComparer());            // combining the 2 lines above
            ...
            availableFlavors.Sort(new AllergenComparer());        // combining the 2 lines above
            foreach (Flavor flavor in availableFlavors)
            {
                Console.WriteLine(flavor);
            }
